...
class AddressBook:
    ...
    def update_contacts(self, contacts_obj):
        self.contacts_dict.update({contacts_obj.first_name: contacts_obj}) and print("Contact Updated...") if contacts_obj.first_name and contacts_obj.last_name in self.contacts_dict else print(
                "No Contacts Found...")

    def delete_contacts(self, first_name):
        self.contacts_dict.pop(first_name) and print("Contact Deleted...") if first_name in self.contacts_dict else print("No Contacts Found...")
